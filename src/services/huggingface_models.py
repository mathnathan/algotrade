...
def setup_huggingface_auth():
    ...
    print("No authentication found. Please run 'huggingface-cli login' or set HUGGINGFACE_HUB_TOKEN")
    return False
...
class FinGPTAnalyzer(BaseSentimentAnalyzer):
    ...
    def __init__(self, cache_dir: Path | str, force_download: bool = False):
        ...
        print(f"FinGPT loaded successfully")
...
def load_sentiment_analyzer(model_name: str, cache_dir: Path = None, force_download: bool = False) -> BaseSentimentAnalyzer:
    """
...
def create_sentiment_analyzer(model_name: str = 'finbert') -> BaseSentimentAnalyzer:
    ...
    """
    return load_sentiment_analyzer(model_name)# Example usage that works identically for both models
